...
export const REPOSITORY_CONTEXT_MCP_HEALTH_CHANNEL = 'repositoryContextMcpHealth';
...
export const IRepositoryContextMcpHealthService =
	createDecorator<IRepositoryContextMcpHealthService>('repositoryContextMcpHealthService');

export interface IRepositoryContextMcpHealthService {
