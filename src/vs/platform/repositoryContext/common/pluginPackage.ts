...
export const PLUGIN_MANIFEST_FILE = 'repository-context-plugin.json';
export const PLUGIN_INSTALL_RECORD_FILE = '.repository-context-install.json';
...
export const IRepositoryContextPluginPackageService =
	createDecorator<IRepositoryContextPluginPackageService>('repositoryContextPluginPackageService');

export interface IRepositoryContextPluginPackageService {
