...
export const IRepositoryContextSkillProjectionService =
	createDecorator<IRepositoryContextSkillProjectionService>('repositoryContextSkillProjectionService');

export interface IRepositoryContextSkillProjectionService {
