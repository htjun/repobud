...
export interface ICanonicalConfiguration {
	...
	readonly integrations: Readonly<Record<string, ICanonicalCapabilitySetting>>;
}
...
export function parseCanonicalConfiguration(
	...
	return {
		...
		integrations: parseCapabilitySettings(value.integrations, 'integrations'),
	};
}

function sortCapabilitySettings(
	settings: Readonly<Record<string, ICanonicalCapabilitySetting>>,
): Record<string, ICanonicalCapabilitySetting> {
